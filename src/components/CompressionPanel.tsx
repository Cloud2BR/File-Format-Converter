  ...
  return (
    <div className="compression-panel">
      <p className="compression-panel__intro">
        {isImage
          ? 'Choose a quality range or maximum size. The download keeps the uploaded image extension.'
          : 'Prepare a download that keeps the uploaded file extension. Processing runs locally in your browser.'}
      </p>
